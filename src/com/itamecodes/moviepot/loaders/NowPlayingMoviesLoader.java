...
public class NowPlayingMoviesLoader extends WrappedAsyncTaskLoader<ArrayList<HashMap<String,String>>> {
	String page;
	static final String TAG="NowPlayingMoviesLoader";
	public NowPlayingMoviesLoader(Context context,String pageno) {
	...
	public ArrayList<HashMap<String,String>> loadInBackground() {
		...
		try {
			String url = "http://api.themoviedb.org/3/movie/now_playing?api_key="
