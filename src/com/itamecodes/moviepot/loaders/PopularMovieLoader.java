...
public class PopularMovieLoader extends WrappedAsyncTaskLoader<ArrayList<HashMap<String,String>>> {
	String page;
	static final String TAG="PopularMovieLoader";
	public PopularMovieLoader(Context context,String pageno) {
