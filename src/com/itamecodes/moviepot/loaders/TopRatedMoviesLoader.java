...
public class TopRatedMoviesLoader extends WrappedAsyncTaskLoader<ArrayList<HashMap<String,String>>> {
	String page;
	static final String TAG="TopRatedMoviesLoader";
	public TopRatedMoviesLoader(Context context,String pageno) {
