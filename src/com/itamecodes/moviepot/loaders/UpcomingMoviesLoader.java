...
public class UpcomingMoviesLoader extends WrappedAsyncTaskLoader<ArrayList<HashMap<String,String>>> {
	String page;
	static final String TAG="UpcomingMoviesLoader";
	public UpcomingMoviesLoader(Context context,String pageno) {
	...
	public ArrayList<HashMap<String,String>> loadInBackground() {
		...
		try {
			String url = "http://api.themoviedb.org/3/movie/upcoming?api_key="
