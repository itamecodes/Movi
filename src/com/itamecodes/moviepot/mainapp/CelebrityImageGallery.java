...
import com.itamecodes.moviepot.adapters.CelebrityImageGalleryAdapter;
import com.itamecodes.moviepot.eventbus.EventBus;
import com.itamecodes.moviepot.loaders.CelebrityImageGalleryLoader;

public class CelebrityImageGallery extends BaseFragment implements LoaderCallbacks<ArrayList<String>>{
	AQuery aq;
	CelebrityImageGalleryAdapter cAd;
	ProgressBar progbar;
	public CelebrityImageGallery() {

	}

	public static CelebrityImageGallery newInstance(String id) {
		CelebrityImageGallery mFrag = new CelebrityImageGallery();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		cAd = new CelebrityImageGalleryAdapter(getActivity(), R.layout.thegalleryimageelement,
	...
	public Loader<ArrayList<String>> onCreateLoader(int arg0,
			Bundle arg1) {
		return new CelebrityImageGalleryLoader(getActivity().getApplicationContext(),
				getargsId());
	}
